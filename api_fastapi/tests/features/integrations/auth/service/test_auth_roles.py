...
from app.features.auth.service.auth_roles_service import RolesService
from app.features.auth.repository.roles_repository import RolesRepository
from app.features.auth.schemas.auth_roles_schema import RolesPermission
...
class TestAuthRolesService:
    ...
    async def test_auth_roles_list(self, add_roles):
        ...
        assert len(retorno.permission) == 0
